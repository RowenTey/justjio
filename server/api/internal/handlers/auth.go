...
func (h *AuthHandler) SignUp(c *fiber.Ctx) error {
	...
	signUpReq := middlewares.GetValidatedRequest[request.SignUpRequest](c)
...
func (h *AuthHandler) Login(c *fiber.Ctx) error {
	ctx := otel.GetOtelContext(c)
	input := middlewares.GetValidatedRequest[request.LoginRequest](c)
...
func (h *AuthHandler) SendOTPEmail(c *fiber.Ctx) error {
	ctx := otel.GetOtelContext(c)
	req := middlewares.GetValidatedRequest[request.SendOTPEmailRequest](c)
...
func (h *AuthHandler) VerifyOTP(c *fiber.Ctx) error {
	ctx := otel.GetOtelContext(c)
	req := middlewares.GetValidatedRequest[request.VerifyOTPRequest](c)
...
func (h *AuthHandler) ResetPassword(c *fiber.Ctx) error {
	ctx := otel.GetOtelContext(c)
	req := middlewares.GetValidatedRequest[request.ResetPasswordRequest](c)
...
func (h *AuthHandler) GoogleLogin(c *fiber.Ctx) error {
	ctx := otel.GetOtelContext(c)
	req := middlewares.GetValidatedRequest[request.GoogleAuthRequest](c)
