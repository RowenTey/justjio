...
func NewUserService(
	...
	return &UserService{
		db:       db,
		userRepo: userRepo,
		logger:   logger.WithFields(logrus.Fields{"service": "UserService"}),
	}
}
...
func (s *UserService) SearchNonFriendUsers(
	ctx context.Context,
	currentUserID, query string,
...
func (s *UserService) GetFriendRequestsByStatus(
	ctx context.Context,
	userID uint,
	status string,
) ([]response.FriendRequestDto, error) {
