...
func (m *MockUserRepository) FindByIDs(ctx context.Context, ids []string) ([]models.User, error) {
...
func (m *MockUserRepository) CreateFriendRequest(ctx context.Context, request *models.FriendRequest) error {
	args := m.Called(ctx, request)
	return args.Error(0)
}

func (m *MockUserRepository) FindFriendRequest(ctx context.Context, id uint) (*models.FriendRequest, error) {
	args := m.Called(ctx, id)
...
func (m *MockUserRepository) FindFriendRequestsByReceiver(ctx context.Context, receiverID uint, status string) ([]models.FriendRequest, error) {
...
func (m *MockUserRepository) GetFriends(ctx context.Context, userID uint) ([]models.User, error) {
...
func (m *MockUserRepository) GetUninvitedFriends(ctx context.Context, roomID, userID string) ([]models.User, error) {
	args := m.Called(ctx, roomID, userID)
	return args.Get(0).([]models.User), args.Error(1)
}

// Search
func (m *MockUserRepository) SearchNonFriendUsers(ctx context.Context, currentUserId, query string, limit int) ([]models.User, error) {
