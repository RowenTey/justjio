...
func (m *MockMessageRepository) FindByID(ctx context.Context, msgID string) (*models.Message, error) {
...
func (m *MockMessageRepository) FindByRoom(ctx context.Context, roomId string, page int, pageSize int, asc bool) ([]models.Message, error) {
