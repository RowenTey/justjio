...
type UserRepository interface {
	...
	FindFriendRequest(ctx context.Context, id uint) (*models.FriendRequest, error)
	UpdateFriendRequest(ctx context.Context, requestID uint, values any) error
	FindFriendRequestsByReceiver(ctx context.Context, receiverID uint, status string) ([]models.FriendRequest, error)
	...
	GetUninvitedFriends(ctx context.Context, roomID, userID string) ([]models.User, error)

	SearchNonFriendUsers(ctx context.Context, currentUserId, query string, limit int) ([]models.User, error)
...
func (r *userRepository) CreateFriendRequest(ctx context.Context, request *models.FriendRequest) error {
...
func (r *userRepository) UpdateFriendRequest(ctx context.Context, requestID uint, values any) error {
	return r.db.WithContext(ctx).Model(models.FriendRequest{ID: requestID}).Updates(values).Error
}
...
func (r *userRepository) SearchNonFriendUsers(ctx context.Context, currentUserId, query string, limit int) ([]models.User, error) {
