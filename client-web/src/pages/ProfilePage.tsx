...
const ProfileContainer: React.FC<ProfileContainerProps> = ({
	...
	return (
		<div className="w-[95%] p-4 flex justify-center items-center bg-white rounded-xl mt-3 shadow-xl">
			<div
				className="w-1/5 flex flex-col gap-3 items-center cursor-pointer"
				onClick={() => navigate("/friends")}
			>
				<p className="text-4xl font-extrabold text-justjio-secondary hover:scale-110">
					{numFriends}
				</p>
			...
			<div className="w-3/5 flex flex-col gap-2 items-center">
				...
				<div className="flex justify-center items-center bg-justjio-secondary border-black border-[1.5px] rounded-3xl px-2 w-[75%]">
					<h3 className="text-lg text-white font-semibold">{username}</h3>
				</div>

				<button className="bg-justjio-primary text-black text-sm font-semibold px-4 py-1 rounded-3xl mt-1">
					Edit Profile
				</button>
			</div>
...
const TransactionHistory: React.FC<TransactionHistoryProps> = ({
	...
	return (
		<div className="w-[95%] h-[60%] p-4 flex flex-col justify-center mt-1 text-black">
			...
			<div
				className={`w-full h-[95%] overflow-y-auto flex flex-col gap-2 py-1 px-1 bg-justjio-primary shadow-xl rounded-md ${
